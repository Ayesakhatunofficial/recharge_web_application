...
class Ruralrationcard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->input->post() != NULL) {
            ...
            $new_name = uniqid('Rfamily_photo-' . date('d-m-Y') . '-') . '.' . $ext;
            ...
            $new_name = uniqid('Rsign-' . date('d-m-Y') . '-') . '.' . $ext;
        ...
        $this->load->view('ruralrationcard', $data);
    }
}

...
class Mobilerecharge_new extends CI_Controller
{
    ...
    public function index()
    {
        if (isset($_SESSION['slug'])) {
            ...
            $datas = $this->Recharge1_model->getRechargeList($recharge_by);

            $total_amount = $this->Recharge1_model->totalRechargeAmount($recharge_by);
        }
        if (isset($_SESSION['role'])) {

            $datas = $this->Recharge1_model->getData();

            $total_amount = $this->Recharge1_model->totalAmount();
        }


        $operators = $this->Recharge1_model->getOperator();
        ...
        $this->load->view('mobilerecharge_new', $view_data);

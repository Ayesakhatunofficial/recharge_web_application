...
class Postpaid extends CI_Controller
{
    ...
    public function getCustomerInfo()
    {
        ...
        $this->form_validation->set_rules('postpaid_number', 'Customer Id', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $postpaid_no = $this->input->post('postpaid_number');
    ...
    public function pay()
    {
        ...
        $this->form_validation->set_rules('pospaid_number', 'Postpaid Number', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $postpaid_no = $this->input->post('pospaid_number');
    ...
    public function history()
    {
        ...
        $bill_data = $this->Postpaid_model->getPostpaidDataList($pay_by);
    ...
    public function bill()
    {
        ...
        $postpaid_bill = $this->db->query(" SELECT 
                                        ...
                                        ON 
                                            tbl_postpaid_operator.opcode = tbl_postpaid.service_code
                                        JOIN 
                                            users
                                        ON 
                                            tbl_postpaid.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_postpaid.id = $id")->row_array();
        ...
        $amount = $postpaid_bill['amount'];
        $words = AmountInWords($amount);

        $words = str_replace(array("\r", "\n"), '', $words);

        if (!is_null($postpaid_bill)) {
            $respond = [
                'status' => true,
                'message' => 'Success',
                'data' => $postpaid_bill,

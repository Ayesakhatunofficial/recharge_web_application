...
class Municiple extends CI_Controller
{
    ...
    public function getCustInfo()
    {
        ...
        $this->form_validation->set_rules('service_no', 'Service Number', 'required');
    ...
    public function bill()
    {
        ...
        $municiple_bill = $this->db->query(" SELECT 
                                        ...
                                        FROM 
                                            tbl_municiple_pay
                                        JOIN 
                                            tbl_municiple_operator
                                        ON 
                                            tbl_municiple_operator.opcode = tbl_municiple_pay.service_code
                                        JOIN 
                                            users
                                        ON 
                                            tbl_municiple_pay.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_municiple_pay.id = $id")->row_array();
        ...
        $amount = $municiple_bill['amount'];

        $words = AmountInWords($amount);

        $words = str_replace(array("\r", "\n"), '', $words);

        if (!is_null($municiple_bill)) {

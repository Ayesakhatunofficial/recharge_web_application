...
class Dthrecharge extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('dth_no', 'DTH Number', 'required');
    ...
    public function bill()
    {
        ...
        $dth_bill = $this->db->query("SELECT 
                                        ...
                                        JOIN 
                                            tbl_dth_operator
                                        ON 
                                            tbl_dth_operator.opcode = tbl_recharge.operator_id
                                        JOIN 
                                            users
                                        ON 
        ...
        if (!is_null($dth_bill) || !empty($dth_bill)) {

            $amount = $dth_bill['amount'];

...
class Cable extends CI_Controller
{
    ...
    public function getCustInfo()
    {
        ...
        $this->form_validation->set_rules('cable_no', 'Cable Number', 'required');
    ...
    public function pay()
    {
        ...
        $this->form_validation->set_rules('cable_no', 'Cable No', 'required');
    ...
    public function bill()
    {
        ...
        $cable_bill = $this->db->query(" SELECT 
                                        ...
                                        JOIN 
                                            tbl_cable_operator
                                        ON 
                                            tbl_cable_operator.opcode = tbl_cable.service_code
                                        JOIN 
                                            users
                                        ON 
                                            tbl_cable.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_cable.id = $id")->row_array();

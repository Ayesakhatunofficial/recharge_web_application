...
class Insurance extends CI_Controller
{
    ...
    public function getCustomerInfo()
    {
        ...
        $this->form_validation->set_rules('cust_dob', 'Customer DOB', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $custNo = $this->input->post('policy_number');
    ...
    public function pay()
    {
        ...
        $this->form_validation->set_rules('cust_dob', 'Customer Date Of Birth', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $insurance_no = $this->input->post('policy_number');
            $email = $this->input->post('email');
            $dob = $this->input->post('cust_dob');
    ...
    public function bill()
    {
        ...
        $insurance_bill = $this->db->query(" SELECT 
                                        ...
                                        JOIN 
                                            users
                                        ON 
                                            tbl_insurance_pay.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_insurance_pay.id = $id")->row_array();
        ...
        $amount = $insurance_bill['amount'];
        $words = AmountInWords($amount);

        $words = str_replace(array("\r", "\n"), '', $words);

        if (!is_null($insurance_bill) && !empty($insurance_bill)) {
            $respond = [
                'status' => true,
                'message' => 'Success',
                'data' => $insurance_bill,
            ...
            $response = [
                'status' => true,
                'message' => 'No Data Found or Id does not exist'
            ];

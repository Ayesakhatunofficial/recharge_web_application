...
class Subscription extends CI_Controller
{
    ...
    public function getCustInfo()
    {
        ...
        $this->form_validation->set_rules('subscription_no', 'Subscription Number', 'required');
    ...
    public function pay()
    {
        ...
        $this->form_validation->set_rules('subscription_no', 'Subscription No', 'required');
    ...
    public function bill()
    {
        ...
        $sub_bill = $this->db->query(" SELECT 
                                        ...
                                        tbl_subscription
                                        JOIN 
                                        tbl_subscription_operator
                                        ON 
                                        tbl_subscription_operator.opcode = tbl_subscription.service_code
                                        JOIN 
                                            users
                                        ON 
                                        tbl_subscription.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                        tbl_subscription.id = $id")->row_array();

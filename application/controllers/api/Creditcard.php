...
class Creditcard extends CI_Controller
{
    ...
    public function getCustomerInfo()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $custNo = $this->input->post('creditcard_number');
    ...
    public function pay()
    {
        ...
        $this->form_validation->set_rules('creditcard_number', 'Customer Number', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $credit_no = $this->input->post('creditcard_number');
    ...
    public function bill()
    {
        ...
        $creditcard_bill = $this->db->query(" SELECT 
                                        ...
                                        FROM 
                                            tbl_creditcard
                                        JOIN 
                                            tbl_creditcard_operator
                                        ON 
                                            tbl_creditcard_operator.opcode = tbl_creditcard.service_code
                                        JOIN 
                                            users
                                        ON 
                                            tbl_creditcard.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_creditcard.id = $id")->row_array();
        ...
        $amount = $creditcard_bill['amount'];

        $words = AmountInWords($amount);

        $words = str_replace(array("\r", "\n"), '', $words);

        if (!is_null($creditcard_bill)) {

            $respond = [
                'status' => true,
                'message' => 'Success',
                'data' => $creditcard_bill,

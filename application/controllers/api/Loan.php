...
class Loan extends CI_Controller
{
    ...
    public function getCustInfo()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $custNo = $this->input->post('loan_number');
    ...
    public function bill()
    {
        ...
        $loan_bill = $this->db->query(" SELECT 
                                        ...
                                        JOIN 
                                            tbl_loan_operator
                                        ON 
                                            tbl_loan_operator.opcode = tbl_loan_payment.service_code
                                        JOIN 
                                            users
                                        ON 
                                            tbl_loan_payment.pay_by =  users.mobile 
                                        JOIN 
                                            user_type
                                        ON 
                                            users.account_type = user_type.id           
                                        WHERE 
                                            tbl_loan_payment.id = $id")->row_array();

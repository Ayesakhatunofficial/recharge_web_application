...
class Gas extends CI_Controller
{
    ...
    public function index()
    {
        if ($_SESSION['role'] || $_SESSION['slug']) {
            ...
            if (isset($_SESSION['role'])) {
                $bill_data = $this->Gas_model->getLPGPayData();
                $total_amount = $this->Gas_model->totalAmount();
            }
            ...
            if (isset($_SESSION['slug'])) {
                ...
                if ($_SESSION['slug'] == 'admin') {
                    ...
                    if (!is_null($users)) {
                        ...
                        $bill_data = $this->Gas_model->getGasDataByMobile($users);

                        $total_amount = $this->Gas_model->totalBillAmountByMobile($users);
                    }
                } else {
            ...
            $services = $this->Gas_model->getService();
    ...
    public function getCustomerInfo()
    {
        ...
        $custNo = $this->input->post('cust_no');
    ...
    public function Payment()
    {
        ...
        $user_1 = $this->Gas_model->getUser($created_by_id);
        $user_1_createdById = $user_1->created_by_id;

        $user_1_type_id = $user_1->create_by;

        $user_2 = $this->Gas_model->getUser($user_1_createdById);
    ...
    public function Status()
    {
        ...
        $pending_data = $this->db->where_in('trans_status_code', $trans_status_codes)->get('lpg_gas_payment')->result_array();

		...
		<tr>
			<td>
				<table width="100%" class="small_latter">
					<tr>
						<td>Receipt No : <strong><?= $electric_bill['id']; ?></strong></td>

						<td style="text-align: right">Customer ID : <strong><?= $electric_bill['customer_id']; ?></strong></td>
					</tr>
					<!-- <tr>
					
				</tr> -->
					<tr>
						<td>Customer Name : <strong><?= $electric_bill['customer_name']; ?></strong></td>
						<td style="text-align: right">Bill Period: : <strong><?= $electric_bill['due_date']; ?></strong></td>
					</tr>
					<!-- <tr>
					...
					<tr>
						<td>Billing Date : <strong><?= date('d-m-Y', strtotime($electric_bill['date'])); ?></strong></td>
						<td style="text-align: right">Due Date : <strong><?= $electric_bill['due_date']; ?></strong></td>
					</tr>

					<tr>
						<td><?= $user['user_type'] ?> Number : <strong><?= 'XXXXXX' . substr($electric_bill['pay_by'], -4) ?></strong></td>
						<td style="text-align: right">TXID : <strong><?= $electric_bill['trans_id']; ?></td>
					</tr>
					<tr>
			...
			<td>
				<table width="100%" class="item_head pro">
					...
					<tr>
						...
						<td style="text-align: center;"><?= round($electric_bill['amount'], 2); ?><br></td>
						<td style="text-align: right;"><?= round($electric_bill['amount'], 2); ?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" class="total_wrap">
					<tr>
						...
						<td width="50%" style="text-align: right;"><?= round($electric_bill['amount'], 2); ?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" class="tb2">
					<tr>
						...
						<td class="right"><strong><?= round($electric_bill['amount'], 2); ?></strong></td>
					</tr>
				</table>
			</td>
		</tr>

<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Electric Bill Payment</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" placeholder="Enter Customer Id" id="cust_id" name="cust_account" required>
                                </div>
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('electricbill_new/Payment') ?>" method="POST">
        ...
        <div class="ibox ibox-warning">
            ...
            <div class="ibox-head">
                <div class="ibox-title">Electric Bill Pay History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_services', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                ...
                                <td>
                                    <?= ($data->trans_status_code == 1) ? $data->profit : "0.000"; ?>
                                </td>
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            if (cust_id && servicecode) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('electricbill_new/getCustomerInfo') ?>',
                    data: {
                        cust_id: cust_id,
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("cust_no").value = cust_id;

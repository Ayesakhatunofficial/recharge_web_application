...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Credit Card Payment</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter Credit Card Number" id="credit_no" name="cust_account" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('creditcard/Payment') ?>" method="POST">
                                    <input type="hidden" id="credit_id" name="credit_no">
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">Credit Card Pay History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_creditcard_operator', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('creditcardbill/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            if (credit_no && servicecode) {
                document.getElementById("loader").style.display = "block";
                document.getElementById("bill_info").style.display = "block";
                // alert(servicecode);
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('creditcard/getCustomerInfo') ?>',
                    data: {
                        credit_no: credit_no,
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("credit_id").value = credit_no;

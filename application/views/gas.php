<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">LPG Gas Payment</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" placeholder="Enter Customer Number" id="cust_no" name="cust_account" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('gas/Payment') ?>" method="POST">
                                    <input type="hidden" id="cust_id" name="cust_no">
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">LPG Gas Payment History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_lpg_operator', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('gasbill/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
            ...
            if (cust_no && servicecode) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("cust_id").value = cust_no;

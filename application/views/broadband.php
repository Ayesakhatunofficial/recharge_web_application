<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Broadband Payment</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                <div class="form-group">
                                    <label>Broadband Number</label>
                                    <input class="form-control" type="text" placeholder="Enter Broadband Number" id="broadband_no" name="cust_account" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('broadband/Payment') ?>" method="POST">
                                    <input type="hidden" id="broadband_id" name="broadband_no">
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">Broadband Pay History</div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('broadbandbill/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            var broadband_no = document.getElementById("broadband_no").value;
            var servicecode = document.getElementById("operator").value;
            if (broadband_no && servicecode) {
                document.getElementById("loader").style.display = "block";
                document.getElementById("bill_info").style.display = "block";
                // alert(servicecode);
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('broadband/getCustomerInfo') ?>',
                    data: {
                        broadband_no: broadband_no,
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("broadband_id").value = broadband_no;

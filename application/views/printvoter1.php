    ...
    <main class="bg">
        <div class="row">
            ...
            if ($voter['language'] == 'HI') {
                $img_url = base_url() . 'votercard/voter1/hindi.jpg';
            } else if ($voter['language'] == 'BN') {
                $img_url = base_url() . 'votercard/voter1/Bengali.jpg';
            } else if ($voter['language'] == 'PA') {
                $img_url = base_url() . 'votercard/voter1/punjabi.jpg';
            } else if ($voter['language'] == 'GU') {
                $img_url = base_url() . 'votercard/voter1/gujarati.jpg';
            } else if ($voter['language'] == 'MR') {
                $img_url = base_url() . 'votercard/voter1/marathi.jpg';
            } else if ($voter['language'] == 'TA') {
                $img_url = base_url() . 'votercard/voter1/tamil.jpg';
            } else if ($voter['language'] == 'KN') {
                $img_url = base_url() . 'votercard/voter1/kannada.jpg';
            } else if ($voter['language'] == 'TE') {
                $img_url = base_url() . 'votercard/voter1/telgu.jpg';
            } else if ($voter['language'] == 'OR') {
                $img_url = base_url() . 'votercard/voter1/odiya.jpg';
            }
            ?>
            <div class="firstpage" style='background-image: url(<?= $img_url; ?>)'>
                ...
                <div class="settable">
                    <table class="tablecss" style="font-weight: bold; font-size: 12px;">
                        <tbody>
                            <tr>
                                <td style="padding-bottom: 15px;"><?php if ($voter['language'] == 'HI') { ?>
                                        नाम
            ...
            $img_back_url = '';
            if ($voter['language'] == 'HI') {
                $img_back_url = base_url() . 'votercard/voter1/hindiback.jpg';
            } else if ($voter['language'] == 'BN') {
                $img_back_url = base_url() . 'votercard/voter1/Bengaliback.jpg';
            } else if ($voter['language'] == 'PA') {
                $img_back_url = base_url() . 'votercard/voter1/punjabiback.jpg';
            } else if ($voter['language'] == 'GU') {
                $img_back_url = base_url() . 'votercard/voter1/gujaratiback.jpg';
            } else if ($voter['language'] == 'MR') {
                $img_back_url = base_url() . 'votercard/voter1/marathiback.jpg';
            } else if ($voter['language'] == 'TA') {
                $img_back_url = base_url() . 'votercard/voter1/tamilback.jpg';
            } else if ($voter['language'] == 'KN') {
                $img_back_url = base_url() . 'votercard/voter1/kannadaback.jpg';
            } else if ($voter['language'] == 'TE') {
                $img_back_url = base_url() . 'votercard/voter1/telguback.jpg';
            } else if ($voter['language'] == 'OR') {
                $img_back_url = base_url() . 'votercard/voter1/odiyaback.jpg';
            }
            ?>
            <div class="secondpage" style='background-image: url(<?= $img_back_url; ?>);'>
                <div class="gender">

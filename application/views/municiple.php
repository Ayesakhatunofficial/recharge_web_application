...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Municiple Service Payment</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter Service Number" id="service_no" name="cust_account" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('municiple/Servicepay') ?>" method="POST">
                                    <input type="hidden" id="service_id" name="service_no">
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">Municiple Service Pay History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_municiple_operator', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('electricbillprint/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            if (service_no && servicecode) {
                document.getElementById("loader").style.display = "block";
                document.getElementById("bill_info").style.display = "block";
                // alert(servicecode);
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('municiple/getCustomerInfo') ?>',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("service_id").value = service_no;

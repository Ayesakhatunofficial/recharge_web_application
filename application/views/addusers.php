                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2_demo_1" name='account_type' required>
                                        ...
                                        ?>
                                            <option value="<?= $account_type['id']; ?>"><?= $account_type['user_type']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" class="form-control" name="mobile" placeholder="98XXXXXX12" required>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="pan" placeholder="AAAAA1234A">
                                </div>
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <input type="number" class="form-control" name="adhar" placeholder="1234XXXX5678">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" maxlength="6" class="form-control" name="pin" placeholder="7XXXX1">
                                </div>

<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Cable Recharge</div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="search_info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter Subscriber Number" id="cable_no" name="cust_account" required>
                                </div>
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('cable/Payment') ?>" method="POST">

                                    <input type="hidden" id="cable_id" name="cable_no">
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">Cable Recharge History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_cable_operator', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                    <img src="<?php echo base_url('operator_image/' . $op_logo['op_logo']); ?>" width=50 height=50>
                                </td>
                                <td><?= $data->trans_id ?></td>
                                <td><?= $data->service_code; ?></td>
                                <td><?= $data->cable_number ?></td>
                                <td><?= $data->amount ?></td>
                                <?php
                                if (isset($_SESSION['role'])) { ?>
                                    <td><?= $data->dr; ?></td>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('cablebill/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            var cable_no = document.getElementById("cable_no").value;

            var servicecode = document.getElementById("operator").value;

            if (cable_no && servicecode) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('cable/getCustomerInfo') ?>',
                    data: {
                        cable_no: cable_no,
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("cable_id").value = cable_no;

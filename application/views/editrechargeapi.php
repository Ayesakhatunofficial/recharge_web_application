        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Edit API</div>
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="purpose" placeholder="Enter Purpose" required value="<?=$recharge_api['purpose'];?>">
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="form-control-label">API URL<b style="color: red;">*</b></label>
                                    <input type="text" class="form-control" name="api_url" placeholder="Enter API URL" required value="<?=$recharge_api['url'];?>">
                                </div>

        ...
        <tr>
            <td>
                <table width="100%" class="small_latter">
                    <tr>
                        <td>Receipt No : <strong><?= $fastag_bill['id']; ?></strong></td>

                        <td style="text-align: right">Customer ID : <strong><?= $fastag_bill['customer_id']; ?></strong></td>
                    </tr>
                    <!-- <tr>
					
				</tr> -->
                    <tr>
                        <td><?= $user['user_type'] ?> Number : <strong><?= 'XXXXXX' . substr($fastag_bill['recharge_by'], -4) ?></strong></td>

                        <td style="text-align: right">TXID : <strong><?= $fastag_bill['trans_id']; ?></td>
                    </tr>
                    <!-- <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">Billing Date : <strong><?= date('d-m-Y', strtotime($fastag_bill['date'])); ?></strong></td>
            ...
            <td>
                <table width="100%" class="item_head pro">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?= round($fastag_bill['amount'], 2); ?><br></td>
                        <td style="text-align: right;"><?= round($fastag_bill['amount'], 2); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" class="total_wrap">
                    <tr>
                        ...
                        <td width="50%" style="text-align: right;"><?= round($fastag_bill['amount'], 2); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" class="tb2">
                    <tr>
                        ...
                        <td class="right"><strong><?= round($fastag_bill['amount'], 2); ?></strong></td>
                    </tr>
                </table>
            </td>
        </tr>

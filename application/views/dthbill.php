	...
	<table width="850" style="padding: 0px;">
		<tr>
			<td style="text-align: center;">
				<img src="<?php echo base_url('operator_image/' . $operator['op_logo']); ?>" width=70 height=60>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<table width="100%" class="small_latter">
					<tr>
						<td>Receipt No : <strong><?= $dth_bill['id']; ?></strong></td>
						<td style="text-align: right">Customer DTH No : <strong><?= $dth_bill['number']; ?></strong></td>
					</tr>
					<!-- <tr>
                 ...
                 -->
					...
					<tr>
						<td>Recharge Date : <strong><?= date('d-m-Y', strtotime($dth_bill['date'])); ?></strong></td>
						<td style="text-align: right">TXID : <strong><?= $dth_bill['ref_id']; ?></td>
					</tr>
					<tr>
						<td><?= $user['user_type'] ?> Number : <strong><?= 'XXXXXX' . substr($dth_bill['recharge_by'], -4) ?></strong></td>
					<tr>
					<tr>
		...
		<tr>
			<td>
				<table width="100%" class="item_head pro">
					...
					<tr>
						<td style="text-align: left;">DTH Recharge For <?= $operator['operator']; ?>
						</td>
						<td style="text-align: center;">1</td>
						<td style="text-align: center;"><?= round($dth_bill['amount'], 2); ?><br></td>
						<td style="text-align: right;"><?= round($dth_bill['amount'], 2); ?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" class="total_wrap">
					<tr>
						...
						<td width="50%" style="text-align: right;"><?= round($dth_bill['amount'], 2); ?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" class="tb2">
					<tr>
						...
						<td class="right"><strong><?= round($dth_bill['amount'], 2); ?></strong></td>
					</tr>
				</table>
			</td>
		</tr>

<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head ">
                        <div class="ibox-title">Post Paid Bill Payment</div>
                        ...
                        <div class="col-md-12 row">
                            <div class="col-md-6" id="search_info">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" placeholder="Enter Mobile Number" id="postpaid_no" name="cust_account" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" id="bill_info" style="display: none;">
                                ...
                                <form action="<?= base_url('postpaidbill/Payment') ?>" method="POST">
                                    <input type="hidden" id="postpaid_no" name="postpaid_no">
                                    ...
                                    <div class="form-group ">
                                        <button class="btn btn-primary btn-lg" type="submit" id="recharge_button" onclick='disableBtn()'>Continue to Payment</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="ibox ibox-warning">
            <div class="ibox-head">
                <div class="ibox-title">Post Paid Bill History</div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($bill_data as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $op_logo = $this->db->get_where('tbl_postpaid_operator', ['opcode' => $data->service_code])->row_array();
                                    ?>
                                    <img src="<?php echo base_url('operator_image/' . $op_logo['op_logo']); ?>" width=50 height=50>
                                </td>
                                <td><?= $data->trans_id ?></td>
                                <td><?= $data->service_code; ?></td>
                                <td><?= $data->postpaid_number ?></td>
                                <td><?= $data->amount ?></td>
                                <?php
                                if (isset($_SESSION['role'])) { ?>
                                    <td><?= $data->dr; ?></td>
                                ...
                                <td>
                                    <?php if ($data->trans_status_code == 1) { ?>
                                        <a href="<?= base_url('postpaidbillprint/index/' . $data->id) ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
    ...
    <script>
        ...
        function getCustomerInfo() {
            ...
            var postpaid_no = document.getElementById("postpaid_no").value;
            // alert(postpaid_no);
            var servicecode = document.getElementById("operator").value;
            if (postpaid_no && servicecode) {
                document.getElementById("loader").style.display = "block";
                document.getElementById("bill_info").style.display = "block";
                // alert(servicecode);
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('Postpaidbill/getCustomer') ?>',
                    data: {
                        postpaid_no: postpaid_no,
                        servicecode: servicecode
                    },
                    dataType: "json",
                    success: function(response) {

                        document.getElementById("postpaid_no").value = postpaid_no;

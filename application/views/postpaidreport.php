        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Postpaid Bill Report</div>
                ...
                <div class="ibox ibox-warning">
                    <div class="ibox-head">
                        <div class="ibox-title">Show Postpaid Bill Report</div>
                        <div class="ibox-tools">
                            <a class="ibox-collapse"><i class="fa fa-minus"></i></a>
                        </div>
                    </div>
                    <div class="ibox-body" style="padding-left: 0;padding-right: 0;">
                        <div class="tab-content">
                            <table class="table table-striped table-bordered table-hover" id="viewdl" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php if (!empty($postpaid_reports)) {
                                        $i = 1;
                                        foreach ($postpaid_reports as $data) { ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td>
                                                    <?php

            ...
            <tbody>
                <tr>
                    ...
                    <td width="40%" style="border: 1px dashed #999; padding: 5px; position: relative;">
                        ...
                        <span style="position: absolute; z-index: 999; margin: 0 auto; left: 0; right: 25px; text-align: center; top: 40%; font-family: Arial, sans-serif; color: #030303; width: 60%; font-weight: bold; text-transform: uppercase;"><?= $pan['pan_no']; ?>
                        </span>
                        <div style="position: absolute;top: 79px;left: 286px;z-index: 9;border: 4px solid #fff;">
                        ...
                        <img src="<?= base_url(); ?>Pancard/pan-front.jpg" width="421" height="266" alt="" />
                    </td>

                    <td width="40%" style="border-top: 1px dashed #999; border-right: 1px dashed #999; border-bottom: 1px dashed #999; padding: 5px;">
                        <img src="<?= base_url(); ?>Pancard/panback.jpg" width="421" height="266" alt="" />
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </tbody>

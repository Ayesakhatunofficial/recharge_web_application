...
((APP = new (APP = function () {
        ...
        $(".metismenu").metisMenu(),
            ...
            $("#_fixedlayout").change(function () {
                $(this).is(":checked")
                    ...
                    : ($("#sidebar-collapse").slimScroll({ destroy: !0 }).css({ overflow: "visible", height: "auto" }), $("body").removeClass("fixed-layout"));
            }),
            ...
            $(".color-skin-box input:radio").change(function () {
                ...
                "default" != e
                    ? $("#theme-style").length
                        ? $("#theme-style").attr("href", "assets/css/themes/" + e + ".css")
                        : $("head").append("<link href='assets/css/themes/" + e + ".css' rel='stylesheet' id='theme-style' >")
                    : $("#theme-style").remove();
            }),
            ...
            $(".fullscreen-link").click(function () {
                $("body").hasClass("fullscreen-mode")
                    ? ($("body").removeClass("fullscreen-mode"), $(this).closest("div.ibox").removeClass("ibox-fullscreen"), $(window).off("keydown", e))
                    : ($("body").addClass("fullscreen-mode"), $(this).closest("div.ibox").addClass("ibox-fullscreen"), $(window).on("keydown", e));
            }),
    ...
    $(function () {
        $.fn.timepicker && ($.fn.timepicker.defaults = $.extend(!0, {}, $.fn.timepicker.defaults, { icons: { up: "fa fa-angle-up", down: "fa fa-angle-down" } }));
    });
